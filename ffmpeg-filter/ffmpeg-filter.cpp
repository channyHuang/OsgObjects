...
const char* filter_brightness = "eq=brightness=0.5[out] ";    //���ȡ�The value must be a float value in range -1.0 to 1.0. The default value is "0". 
const char* filter_contrast = "eq=contrast=1.5[out] ";        //�Աȶȡ�The value must be a float value in range -2.0 to 2.0. The default value is "1". 
const char* filter_saturation = "eq=saturation=1.5[out] ";    //���Ͷȡ�The value must be a float in range 0.0 to 3.0. The default value is "1". 
